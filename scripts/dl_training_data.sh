...
# video clip training data
gdown --folder 10pjrRpPsV-zV-FtaO-AoKXqu3KdxM-1b -O haptic_training_label/


tar -xvf haptic_training_label/training_data/dexycb.tar -C haptic_training_label/
tar -xvf haptic_training_label/training_data/arctic.tar -C haptic_training_label/
tar -xvf haptic_training_label/training_data/ho2o.tar -C haptic_training_label/
tar -xvf haptic_training_label/training_data/ho3d.tar -C haptic_training_label/
tar -xvf haptic_training_label/training_data/interhand.tar -C haptic_training_label/


rm -r haptic_training_label/training_data
